...
### Syntax
fucking code othrographe (like that ptdr…)\
; -> end of a line (order) think abt telegraphe -> stop. To each line to finish it\
Snowball the shit\
->**NE COMPILE PAS**

### Link
if main not found or anything called in the prog.

### Exceptions
Execution fault - big shit big time - break the prog. (BAJ BRAVO NILS, SUPER POUR LA CAMERA)\
...
### Segmentation fault 
GOLD shiny big time en sécu -> tentative de r/w smwh à un endroit interdit (oh nio so dramatiiiiic)\
Pointeur - bête noir (ASKIP)\
frr, t'attribue, tu utilises, tu nettoies et pis voilà ptn, laisse rien trainer, just beware of the fucking leaks.\
Comme la lessive enft ou une map d'une ville/un immeuble

### Runtime
Erreur d'execution ou de logique\
